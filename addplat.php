...
<html>
    ...
    <nav>
                ...
                <li><span><a href="ajouterunplat.php"  class="desktop-link">AJOUTER  PLAT</a></span></li>
...
<div class="form-group">
<input type="text" name="type2" class="form-control" placeholder="type2" required="required" autocomplete="off">      
</div> 
<div class="form-group">    
...
if(isset($_FILES['userfile'])&& isset($_POST['type'])&& isset($_POST['type2'])){
    ...
    for ($i=0;$i<count($file_array);$i++){
        if ($file_array[$i]['error']) 
        {
            ...
            if (!in_array($file_ext, $extensions)) 
            {
                ...
                $description2=$_POST['type2'];
                $description=$_POST['type'];
                $img_dir = 'Images/Menu'.$file_array[$i]['name'];
                
                move_uploaded_file($file_array[$i]['tmp_name'], $img_dir);
                
                $sql = "INSERT INTO type (name,img_dir,type,type2) VALUES('$name','$img_dir','$description','$description2')";
